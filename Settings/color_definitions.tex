...
\definecolor{erasmusDarkBlue}{RGB}{12,32,116}
\definecolor{erasmusLightBlue}{RGB}{143,210,237}
\definecolor{erasmusWhite}{RGB}{255,255,255}
\definecolor{erasmusGrey}{RGB}{75, 75, 75}
\definecolor{erasmusBlack}{RGB}{0, 0, 0}
\definecolor{erasmusOrange}{RGB}{255, 165, 0}
...
% Make the references blue or black
\definecolor{references}{rgb}{0.0, 0.0, 1.0}
%\definecolor{references}{rgb}{0.0, 0.0, 0.0}

% Background color from cover to use in part pages
\definecolor{partbackground}{RGB}{17, 35, 89}
